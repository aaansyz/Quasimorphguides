...
function StructuredData({page}:{page:PageEntry}) {
  ...
  const canonical=`https://quasimorphwiki.com${page.path}`;
  ...
  const image={"@type":"ImageObject","@id":"https://quasimorphwiki.com/#primaryimage",url:"https://quasimorphwiki.com/og-cyan.png",contentUrl:"https://quasimorphwiki.com/og-cyan.png",width:1200,height:630};
  const organization={"@type":"Organization","@id":"https://quasimorphwiki.com/#organization",name:"Quasimorph Wiki",url:"https://quasimorphwiki.com/about/"};
  const graph:Record<string,unknown>[]=[{"@type":"WebPage","@id":canonical,url:canonical,name:meta?.title||page.title,description:meta?.description||page.description,inLanguage:"en",datePublished:meta?.publishedAt,dateModified:meta?.modifiedAt||verifiedAt,isPartOf:{"@id":"https://quasimorphwiki.com/#website"},primaryImageOfPage:image},{"@type":"BreadcrumbList","@id":`${canonical}#breadcrumb`,itemListElement:[{"@type":"ListItem",position:1,name:"Home",item:"https://quasimorphwiki.com/"},...crumbs]}];
  if(meta&&["guide","article"].includes(meta.kind)) graph.push({"@type":"Article",headline:meta.title,description:meta.description,image:"https://quasimorphwiki.com/og-cyan.png",inLanguage:"en",isAccessibleForFree:true,datePublished:meta.publishedAt,dateModified:meta.modifiedAt,author:organization,publisher:organization,mainEntityOfPage:{"@id":canonical}});
...
export function HomePage(){
  return <Shell>
    <script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify({"@context":"https://schema.org","@graph":[{"@type":"Organization","@id":"https://quasimorphwiki.com/#organization",name:"Quasimorph Wiki",alternateName:"QuasimorphWiki.com",url:"https://quasimorphwiki.com/",logo:{"@type":"ImageObject","@id":"https://quasimorphwiki.com/#logo",url:"https://quasimorphwiki.com/logo-mark.svg",contentUrl:"https://quasimorphwiki.com/logo-mark.svg",width:512,height:512},description:"An independent, source-visible field archive for Quasimorph players."},{"@type":"WebSite","@id":"https://quasimorphwiki.com/#website",name:"Quasimorph Wiki",alternateName:"QuasimorphWiki.com",url:"https://quasimorphwiki.com/",inLanguage:"en",publisher:{"@id":"https://quasimorphwiki.com/#organization"},description:"Task-focused Quasimorph 1.0 guides, local planning tools and source-visible update coverage."},{"@type":"ImageObject","@id":"https://quasimorphwiki.com/#primaryimage",url:"https://quasimorphwiki.com/og-cyan.png",contentUrl:"https://quasimorphwiki.com/og-cyan.png",width:1200,height:630},{"@type":"WebPage","@id":"https://quasimorphwiki.com/",url:"https://quasimorphwiki.com/",name:"Quasimorph Wiki — 1.0 Guides & Planning Tools",description:"Task-focused Quasimorph 1.0 guides, verified update coverage, achievements and a mission planning tool.",inLanguage:"en",isPartOf:{"@id":"https://quasimorphwiki.com/#website"},about:{"@id":"https://quasimorphwiki.com/#organization"},primaryImageOfPage:{"@id":"https://quasimorphwiki.com/#primaryimage"}}]})}}/>
